model conditions
    ...
    output Real t_s(unit = "ºC")    = 228 "Temperatura de saturação água/vapor";
    output Real t_agua(unit = "ºC") = 105 "Temperatura da água de alimentação";
    output Real t_ref(unit = "ºC")  = 25 "Temperatura ambiente ou referência";

    output Real V_st(unit = "m³") = 2 "Volume de vapor no Ponto de Operação";
    output Real V_wt(unit = "m³") = 12.4645 "Volume de água no Ponto de Operação";
    output Real V_t(unit = "m³")  = 14.4645 "Volume total";

    output Real m_t(unit = "kg") = 12324.333 "Massa total de metal";

    output Real cp_metal(unit = "kJ/(kgºC)") = 0.550 "Calor específico do metal";
